...
## Overview     
<i>Please note that all of the figures in this overview and in the subsequent sections are estimates based on U.S. Census survey samples. So all figures should be read as "approximately" even when the word "approximately" does not appear. </i>  
