...
* In 2015, there were approximately xxx4,636,487 professionals in the U.S. tech sector; xxx4,066,773 were Amereicans (xxx87.7 percent); xxx569,714 were foreign (12.3 percent)
* In 2015 there were approximately xxx569,714 foreign tech professionals in the  U.S. workforce (Table 1E). Approximately xxx407,481 were from Asian countries; xxx162,233 were from non-Asian countries. (See Table 1E)    

* In 2015 approximately xxx80 % of foreign techs were male; xxx20 % were female; xxx15.7 % of foreign techs were female who came from Asian countries; xxx4.3 % female tachs came from non-Asian countries. (See Chart 4 and Table 2C)

  <img src="ggChart4.png" style="width:600px;height:300px;" />
  
* xxx54.6 percent of foreign techs were concentrated in six states (Chart 5 and Table 4.1) -- California (xxx127,671), Texas (52,885), New York (xxx42,075), New Jersey (xxx31,859), Washington (xxx31,201), and Illinois (xxx25,359). These states also experienced the largest increases in the employment of foreign techs between 2010 and 2015 (Chart 5 and Table 3G).

  <img src="ggChart5.png" style="width:600px;height:300px;" />

* American firms employed foreign techs because they claimed that they could not find enough qualified American techs in the domestic job pipelines. Employment of foreign techs in the 50 states plus the District of Columbia increased by xxx32.7 percent between 2010 and 2015 (Table 3EE). By contrast, employment of American techs increased by only xxx22.4 percent (Table 3ZZ) during that time frame.

* Given that cloud computing and machine learning became principal drivers in the expansion of the U.S. tech sector during the last five years, contrasts between increase in American vs. foreign tech employment in three job categories is especially noteworthy -- software developers, database administrators, and computer/research scientists.  
...
* In 2015 California employed the largest number of foreign techs in all three categories -- software developers = xxx74,399; database administrators = xxx2,650 ; and computer/research scientists = xxx993 (Table 3G)
