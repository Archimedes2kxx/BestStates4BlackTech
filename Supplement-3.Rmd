---
title: "Foreign Professionals: U.S. Tech's Other Pipelines -- Version 0.83"
...
For more convenient reference, extracts of data from Tables 3ZZ  and 3EE about the three key job categories appear in the labelled sections of Table 3F (below). The first section displays data about American techs in 2010 and 2015; the second shows data foreign techs; the third about their combined totals; and the fourth shows the percentage of these critical jobs held by foreign techs:
...
As per Table 1C, the share of jobs in the U.S. tech sector held by foreign professionals increased from xxx percent in 2010 to xxx percent in 2015. This small increase was the net result of increases and decreases in the thirteen job categories that were used to define the tech sector. Closer examination disclosed that foreign professionals gained substantial increases in their shares of the three job categories most closely associated with cloud computing and AI/machine learning, the most important innovations driving the expansion of the U.S. tech sector in recent years (Table 3F):
