---
title: "Foreign Professionals: U.S. Tech's Other Pipelines -- Version 0.79"
...
3. <b>perSS</b> – The state’s share of all Asian or non-Asian techs in the U.S. For example, Table 4G shows that xxxx9.3 percent of the techs from Asian countries worked in California; and xxx7 percent of all techs from Asian countries worked in Texas.
...
5. <b>perT</b> – Percent of all foreign techs in each state who were from Asian countries (Table 4G) or were from non-Asian countries (Table 4H). For example, Table 4G shows that `r prettyNum(dfTable4G[dfTable4G$State=="California", "perAsian"], big.mark=",", scientific=FALSE)`xxx73.0 percent of all techs in the U.S. who were from from Asian countries worked in California. Table 4H shows that `r prettyNum(dfTable4H[dfTable4H$State=="California", "perNonAsian"], big.mark=",", scientific=FALSE)` xxx27.0 percent of all the techs from non-Asian countries worked in California.
