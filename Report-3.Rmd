...
* I am currently developing a supplement to this report that will provide data that focuses on the increasing employment of foreign tech professionals in U.S. tech, especially in Silicon Valley. Thereafter I will post a companion op-ed on this blog -- <i>"Why Are There So Many Foreign Techs in U.S. tech?</i>" -- that will offer a plausible answer to the question in its title based on the data compiled for this report and data gathered from other sources.
