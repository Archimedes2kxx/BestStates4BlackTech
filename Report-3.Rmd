...
* Table 5 showed that the national parity rating for Blacks in tech was `r dfTable5["Black", "Par"]`, i.e., `r dfTable1B[2,3]` divided by `r dfTable1A[2,3]`, which was more than half, i.e., greater than 0.50. Given that the vast majority of tech jobs required bachelors degrees, this meant that, contrary to the fables perpetrated by Silicon Valley's tech executives in their annual reports for the last three years, <b>the nation's Black academic pipelines were more than half-full; they were not perilously close to empty</b>.  
