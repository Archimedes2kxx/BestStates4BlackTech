...
The scripts and their embedded functions should be run in numerical order: Data-1 creates the dataframe required by StatsGraphs-2; And StatsGraps-2 creates the statistics and graphics required by the Report-3 script.
