---
title: "Best States for American Black, Hispanic, Asian, and Female Tech -- Version 0.99M"
...
caPerForeignIncrease <- round(100* (dfTable3FF[1,"Change"] / dfTable3EE[1,"Change"]), digits=1)

otherPerForeignIncrease <- round(100.0 - caPerForeignIncrease, digits=1)
```
## Overview   
...
* The increase in foreign tech professionals was highest in California. The number of foreign tech professionals working in California increased by `r prettyNum(dfTable3FF[1,"perCh"], big.mark=",", scientific=FALSE)` percent between 2010 and 2015, i.e. from  `r prettyNum(dfTable3FF[1,"Tech10"], big.mark=",", scientific=FALSE)` to  `r prettyNum(dfTable3FF[1,"Tech15"], big.mark=",", scientific=FALSE)`. In other words, California accounted for `r caPerForeignIncrease` percent of the  `r prettyNum(dfTable3EE[1,"Change"], big.mark=",", scientific=FALSE)` increase in the number of foreign professionals working in U.S. tech during that time frame. The remaining `r otherPerForeignIncrease` percent was spread across the other 49 states and the District of Columbia. (See Tables 3EE and 3FF)
...
<i>Answer 1A</i> The answers to this question are shown in Table 1A (below). Many of the tables in this section have the same format. The top row, labelled "Num" as an abbreviation for "Number", shows how many workers fall into the category of the heading of the column: American "Citizen", "Foreign" worker, and their combined "Total". The second row, labelled "Per" as short for "Percentage", shows the percentge of the "Total" for each of the numbers in the first row.
...
#### Question 2 -- What was the  male/female composition of the U.S. tech sector in 2015?
...
<b>Table 2B -- American Male, American Female Composition of the U.S. Tech Sector in 2015</b>   
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
#### Question 3 -- How did the racial, ethnic, foreign, and male/female shares of the job categories in U.S. tech change between 2010 and 2015?  

The seven pairs of tables in this section display profiles of the various groups considered in this report. 

For the purposes of this report, "information technology" was defined as the thirteen standard occupation categories (SOC) that appear in the first column of the following tables. Twelve categories related to software, e.g., Software Developers, Computer Programmers, and Database Administrators; only one related to hardware, i.e., Computer Hardware Engineers.     
...
* <b>perTS</b> ... the "Percentage of Tech Share", which shows the percentage of the total number of tech workers that were employed in each job category. For example, the xxx workers in "Software Development" represented xxx percent of the xxx total number of tech workers in 2015. The xxx workers "Computer Programmers" were xxx percent of the total XXX tech workers.   

* <b>Fem</b> ... the number of "Female" tech workers". The number of males can be calculated by substracting the female workers from the total number of workers in each category. For example, there were xxx software developers in 2015 of which xxx were female. So the number of male software developers was xxx - xxx = xxx. 

* <b>perF10</b> ... the "Percent Female in 2010" displays the percent of jobs in each category that were held by female techs in 2010

* <b>perF15</b> ... the "Percent Female in 2015" displays the percent of jobs in each category that were held by female techs in 2015.

* <b>Change</b> ... the difference between the number of workers in each job category in 2010 and the number in 2015.   
...
<i>Question 3.0</i> -- How many American male vs. female techs were in each category in 2010 and 2015 in the 50 states and the District of Columbia?
 ...
 <i>Answer 3.0</i> ... As per its title, Tables 3Z and 3ZZ (below) only contains data about tech workers who were American citizens; data about foreign workers will appear in Tables 3E and 3F (subsequent.)
...
```
 ...
 <b>Table 3CC -- Changes in the Hispanic American Composition of U.S. Tech Between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<i>Question 3D</i> -- How many Hispanic American male vs. female techs were in each category in 2010 and 2015 in the 50 states and the District of Columbia?   
 ...
 <b>Table 3D -- Asian American Male/Female Composition of U.S. Tech in 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3D, big.mark=","), row.names=FALSE, quote=FALSE)
```

 <b>Table 3DD -- Changes in the Asian American Composition of U.S. Tech Between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3DD, big.mark=","), row.names=FALSE, quote=FALSE)
```
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>  

<i>Question 3E</i> -- How many foreign male vs. female tech were in each category in 2010 and 2015 in the 50 states and the District of Columbia? 

 <i>Answer 3A</i> ... Data for foreign tech workers in 2015 is in Table 3A; data that compares 2010 to 2015 is in Table 3EE.
...
<b>Table 3EE -- Changes in the Foreign Male/Female Composition of U.S. Tech in 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<i>Question 3F</i> -- How many foreign male vs. female tech were in each category in 2010 and 2015 in California? 

  <i>Answer 3F</i> ... Data for foreign techs working in California in 2015 is in Table 3F; data that compares 2010 employment to 2015 is in Table 3FF. Note that the huge increases in the estimated number of foreign techs in all job categories in 2015 from low initial values in 2015 were reflected in the four digit percentage increases shown in the "perCh" column. The "Inf" entries (abbreviations for "Infinite") merely indicates that there were zero foreign techs in those categories in 2010.   

* The number of foreign tech professionals working in California increased by `r prettyNum(dfTable3FF[1,"perCh"], big.mark=",", scientific=FALSE)` percent between 2010 and 2015, i.e. from  `r prettyNum(dfTable3FF[1,"Tech10"], big.mark=",", scientific=FALSE)` to  `r prettyNum(dfTable3FF[1,"Tech15"], big.mark=",", scientific=FALSE)`.       

*  California accounted for `r caPerForeignIncrease` percent of the  `r prettyNum(dfTable3EE[1,"Change"], big.mark=",", scientific=FALSE)` increase in the number of foreign professionals working in U.S. tech during that time frame noted in Table 3E. The remaining `r otherPerForeignIncrease` percent was spread across the other 49 states and the District of Columbia.
 
 <b>Table 3F -- California Foreign Male/Female Composition of U.S. Tech in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3F, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3FF -- Changes in the California Foreign Male/Female Composition of U.S. Tech between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
#### Question 4 -- Where did American and foreign tech professionals work in 2015?      
Answer 4 ... The following sections provide an extensive response to a more specific formulation of this question ==> In which states did American and foreign tech professionals work in 2015?  

Table 4 (below) lists the six states that employed the most American techs in 2015. These states will also appear in just about every table that follows because  they employed such a large share (`r prettyNum(dfTable4[1, "Top6_%"])` percent) of the `r prettyNum(dfTable4[1, "ALL STATES"], big.mark=",", scientific=FALSE)` American techs in the U.S.
...
* Map 4G shows that foreign tech workers from Asia had their highest concentration in California

* Map 4H shows that foreign tech workers from outside Asia had their highest concentration in California. 
...
* All of the parity values of the top 10 states for Black Ameican techs shown in the last column of Table 4B are substantially higher than the parity values for all of the top 10 states for Hispanic techs shown in Table 4D ... with one exception: Florida, parity = `r dfTable4D["Florida", "Par"]`x. Florida's parity value for Hispanic techs was more than twice the `r dfTable4D["California", "Par"]`x parity value for Hispanics in California. Indeed, Table 4D shows that California had the lowest parity value of all of the top ten states for Hispanics. These considerations suggests that Hispanic techs may have encountered larger employment barriers than Black techs, especially in California.   
...
```{r, echo=FALSE, cache=FALSE, comment=NA}
    colnames(dfTable4G) <- c("State", "Foreign", "perSS", "AsiaTech", "perT")
...
```{r, echo=FALSE, cache=FALSE, comment=NA}
    colnames(dfTable4H) <- c("State", "Foreign", "perSS", "NAsiaTech", "perT")
print(format(dfTable4H[1:11,], big.mark = ","), row.names=FALSE)  

```
<b>Comments about Tables 4G and 4H -- Foreign Tech Professionals from Asia </b>  

* As per the second row in Table 4G (above), `r prettyNum(dfTable4G["California","AsiaTech"], big.mark=",", scientific=FALSE)` techs from Asia worked in California in 2015; and as per the second row in Table 4H (above), `r prettyNum(dfTable4H["California","NAsiaTech"], big.mark=",", scientific=FALSE)` techs from outside Asia worked there. The perSS columns in these tables show that these employment levels represented `r prettyNum(dfTable4G[dfTable4G$State=="California","perSS"], big.mark=",", scientific=FALSE)` percent of all foreign techs from Asia (Table 4G) and `r prettyNum(dfTable4H["California","perSS"], big.mark=",", scientific=FALSE)` of all foreign techs from outside Asia (Table 4H).  Texas ranked second for both groups, but its `r prettyNum(dfTable4G["Texas","perSS"], big.mark=",", scientific=FALSE)`  and `r prettyNum(dfTable4H["Texas","perSS"], big.mark=",", scientific=FALSE)` percentage shares were substantially lower than the foreign percentages in California, but were only marginally higher than the `r prettyNum(dfTable4G["New York","perSS"], big.mark=",", scientific=FALSE)` and `r prettyNum(dfTable4H["New York","perSS"], big.mark=",", scientific=FALSE)` percentage shares for New York, the third ranking state for both groups.   
    
    
* The presence of so many foreign professionals in California's tech sector invites comparisons to its employment of Black and Hispanic Americans. The `r prettyNum(dfTable4G["California","Foreign"], big.mark=",", scientific=FALSE)` professionals in California's foreign cohort in 2015 (Tables 4G & 4H, second row) was `r prettyNum(round(dfTable4G["California","Foreign"]/dfTable4B["California","BlkTech"], digits=1), big.mark=",", scientific=FALSE)` times as large as the `r prettyNum(dfTable4B["California","BlkTech"], big.mark=",", scientific=FALSE)` Black American techs (Table 4B) who worked there and `r prettyNum(round(dfTable4G["California","Foreign"]/dfTable4D["California","HspTech"], digits=1), big.mark=",", scientific=FALSE)` times as large as the `r prettyNum(dfTable4D["California","HspTech"], big.mark=",", scientific=FALSE)` Hispanic American techs (Table 4D).  
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small> 
...
Which states were the best states for White, Black, Hispanic, Asian, and female American professionals in information technology? Given the limited scope of the data that examined in this study, its selection criteria were rudimentary; so its conclusions should be regarded as tentative first approximations. 
...
* As shown in Tables 5, the betas and national parity values for Asian American females (`r dfTable5["FemAsian", "beta1000"]` and `r dfTable5["FemAsian", "Par"]`) were much higher than the values for non-Asian females (`r dfTable5["FemNonAsian", "beta1000"]` and `r dfTable5["FemNonAsi", "Par"]`).  In other words, Asian American females received substantially greater employment opportunities than non-Asian American females all over the country. So what were they doing or perceived to be doing that made them more employable in the 50 states and DC? What were their "best practices" that accounted for their higher scores?

* This is not to say that tech treated Asian American males and Asian American females the same. Not at all. The betas and national parity values assigned to Asian Americans as a whole (`r dfTable5["Asian", "beta1000"]` and `r dfTable5["Asian", "Par"]`) were much higher than the values assigned to Asian females (`r dfTable5["FemAsian", "beta1000"]` and `r dfTable5["FemAsian", "Par"]`). Therefore the values assigned to Asian American males had to be much higher than the values assigned to Asian American females. In other words Asian American males received substantially greater employment opportunities per capita than Asian American females.
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>  
...
* In most states, being in tech means working in the information technology sections of government agencies or private corporations in various industries; whereas in California and to a lesser extent in Texas, a substantial number of techs work for computer companies.  A large part of the Hispanic American workforce in Florida has Cuban ancestry; whereas large parts of the Hispanic American workforce in California and Texas have Mexican ancestry. Cuban entrepreneurs have established many prominent businesses in Florida. Indeed, Miami has been often been called the "financial capital" of Latin America,     
...
* As can be seen from the tables in the <B>[APPENDIX](https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html#appendix-profiles-of-racialethnic-groups-sex-and-foreign-composition-of-six-biggest-tech-states-in-2015)</b> section of this report, California's increased use of foreign tech professionals in the last few years is orders of magnitude larger than other states. California's foreign tech tables display four digit percentage increases in the imporation of foreign techs. Whereas the increased use of foreign techs by the other five big tech states might be tactical responsonses to local shortfalls in the availability of American techs, California's substantially larger use of foreign professionals seems more like a long-term strategy that is widely shared by upper level tech managers in that state, especially in Silicon Valley.

* The DLL will soon post a companion op-ed -- <i>"Why Are There So Many Foreign Techs in California?</i>" -- that will offer a plausible answer to the question in its title based on the data compiled for this report and data gathered from other sources.
...
Of course Python, MATLAB, or other comparable languages could be used insted of R, and the supplementary files could be stored on other public repositories comparable to GitHub. This being my first attept to write a reproducible report, I wrote it in R and stored my supporting files in a public <b>[GitHub repo](https://github.com/Archimedes2kxx/BestStatesForBlackTech)</b>. If readers disagree with my numbers, they won't have to wonder how I got them <i>... #OldDogStillLearningNewTricks ... :-)</i>   
...
application to download two samples from the Public Use Microdata Sample (PUMS) from the Bureau's American Community Survey for 2015. The first sample was used to estimate the size of the White, Black, Asian, Hispanic, and female components of the total workforce in each of the 50 states plus the District of Columbia. The second, more detailed sample was used to estimate size of the corresponding components of the tech subset of the total workforce. The second sample (`r prettyNum(dim(dfCensus2)[1], big.mark=",", scientific=FALSE)` observations) was usually large enough to make good estimates of the employee counts and percentages of tech employment for Blacks, Whites, Asians, and Hispanics in tech occupations in the 50 states and DC. (<i>Note: For a few low states with low workforce populations, the ACS subset included missing values which meant that it wasn't large enough to provide reliable estimates of the racial/ethnic breakdown of tech employment in those states</i>.)  My step-by-step procedures for selecting and downloading the ACS data and its codebook is described in <b>[Notes-Data-Download-PUMS-Sample](https://archimedes2kxx.github.io/BestStatesForBlackTech/Notes-Data-Download-PUMS-Sample.html)</b> on the <b>[GitHub repo](https://github.com/Archimedes2kxx/BestStatesForBlackTech)</b>.<br />

<b>Selected Data</b><br/> 

* <b>Occupation</b><br />When using the DataFerret app to select a sample of tech professionals from the full PUMS 2015 sample, I defined the "information technology sector" by designating the 13 standard occupational categories shown in Table 3. Twelve categories were software, one was hardware   
...
## Appendix -- Profiles of Racial/Ethnic Groups, Sex, and Foreign Composition of Six Biggest Tech States in 2015
...
### California ... California ...California ... California ... California ...  
 ...
 <b>Table 3CA -- American Male/Female Composition of Tech in California in 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3CA, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3CACA -- Changes in American Composition of Tech in California between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>  
 ...
 <b>Table 3CAblack -- Black American Male/Female Composition of Tech in California in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3CAblack, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3CACAblack -- Changes in Black American Composition of Tech in California between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>    
 ...
 <b>Table 3CAhispanic -- Hispanic American Male/Female Composition of Tech in California in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3CAhispanic, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3CACAhispanic -- Changes in Hispanic American Composition of Tech in California between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>   
 ...
 <b>Table 3CAfor -- Foreign Male/Female Composition of Tech in California in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3CAfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3CACAfor -- Changes in Foreign Male/Female Composition of Tech in California between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3CACAfor, big.mark=","), row.names=FALSE, quote=FALSE)
```
...
### Texas ... Texas ... Texas ... Texas ... Texas ... Texas ... Texas ...  
 ...
 <b>Table 3TX -- American Male/Female Composition of Tech in Texas in 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3TX, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3TXTX -- Changes in American Composition of Tech in Texas between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>  
 ...
 <b>Table 3TXblack -- Black American Male/Female Composition of Tech in Texas in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3TXblack, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3TXTXblack -- Changes in Black American Composition of Tech in Texas between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>    
 ...
 <b>Table 3TXhispanic -- Hispanic American Male/Female Composition of Tech in Texas in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3TXhispanic, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3TXTXhispanic -- Changes in Hispanic American Composition of Tech in TExas between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3TXTXhispanic, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3TXfor -- Foreign Male/Female Composition of Tech in Texas in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3TXfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3TXTXfor -- Changes in Foreign Male/Female Composition of Tech in Texas between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3TXTXfor, big.mark=","), row.names=FALSE, quote=FALSE)
```
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>  

### New York ... New York ... New York ... New York ... 

 <b>Table 3NY -- American Male/Female Composition of Tech in New York in 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3NY, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3NYNY -- Changes in American Composition of Tech in New York between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>  
 ...
 <b>Table 3NYblack -- Black American Male/Female Composition of Tech in New York in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3NYblack, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3NYNYblack -- Changes in Black American Composition of Tech in New York between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>    
 ...
 <b>Table 3NYhispanic -- Hispanic American Male/Female Composition of Tech in New York in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3NYhispanic, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3NYNYhispanic -- Changes in Hispanic American Composition of Tech in New York between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3NYNYhispanic, big.mark=","), row.names=FALSE, quote=FALSE)
```


 <b>Table 3NYfor -- Foreign Male/Female Composition of Tech in New York 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}  
   print(format(dfTable3NYfor, big.mark=","), row.names=FALSE, quote=FALSE)
```


<b>Table 3NYNYfor -- Changes in Male/Female Composition of Tech in New York between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3NYNYfor, big.mark=","), row.names=FALSE, quote=FALSE)
```
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>     

### Florida ... Florida ... Florida ... Florida ...  
 
 <b>Table 3FL -- American Male/Female Composition of Tech in Florida in 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3FL, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3FLFL -- Changes in American Composition of Tech in Florida between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>  
 ...
 <b>Table 3FLblack -- Black American Male/Female Composition of Tech in Florida in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3FLblack, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3FLFLblack -- Changes in Black American Composition of Tech in Florida between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>    
 ...
 <b>Table 3FLhispanic -- Hispanic American Male/Female Composition of Tech in Florida in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3FLhispanic, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3FLFLhispanic -- Changes in Hispanic American Composition of Tech in Florida between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3FLFLhispanic, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3FLfor -- Foreign Male/Female Composition of Tech in Florida in 2015</b>
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3FLfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3FLFLfor -- Changes in Foreign Male/Female Composition of Tech in Florida between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3FLFLfor, big.mark=","), row.names=FALSE, quote=FALSE)
```
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>     

### Virginia ... Virginia ... Virginia ... 
 
 <b>Table 3VA -- American Male/Female Composition of Tech in Virginia in 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3VA, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3VAVA -- Changes in American Composition of Tech in Virginia between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>  
 ...
 <b>Table 3VAblack -- Black American Male/Female Composition of Tech in Virginia in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3VAblack, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3VAVAblack -- Changes in Black American Composition of Tech in Virginia between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>    
 ...
 <b>Table 3VAhispanic -- Hispanic American Male/Female Composition of Tech in Virginia in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3VAhispanic, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3VAVAhispanic -- Changes in Hispanic American Composition of Tech in Virginia between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3VAVAhispanic, big.mark=","), row.names=FALSE, quote=FALSE)
```
 
<b>Table 3VAfor -- Foreign Male/Female Composition of Tech in Virginia in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3VAfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3VAVAfor -- Changes in Foreign Male/Female Composition of Tech in Virginia between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3VAVAfor, big.mark=","), row.names=FALSE, quote=FALSE)
```
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>    

### Illinois ... Illinois ... 
 
 <b>Table 3IL -- American Male/Female Composition of Tech in Illinois in 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3IL, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3ILIL -- Changes in American Composition of Tech in Illinois between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>  
 ...
 <b>Table 3ILblack -- Black American Male/Female Composition of Tech in Illinois in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3ILblack, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3ILILblack -- Changes in Black American Composition of Tech in Illinois between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>    
 ...
 <b>Table 3ILhispanic -- Hispanic American Male/Female Composition of Tech in Illinois in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3ILhispanic, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3ILILhispanic -- Changes in Hispanic American Composition of Tech in Illinois between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3ILILhispanic, big.mark=","), row.names=FALSE, quote=FALSE)
```
 
<b>Table 3ILfor -- Foreign Male/Female Composition of Tech in Illinois in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3ILfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3ILILfor -- Changes in Foreign Male/Female Composition of Tech in Illinois between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3ILILfor, big.mark=","), row.names=FALSE, quote=FALSE)
```
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>    
