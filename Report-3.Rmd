...
### B. Findings
Question 1A -- How many Whites, Blacks, Hispanics, Asians, and others were living in the U.S. in 2014?   
Answer 1A -- See Table 1A (below)   

<b>Table 1A -- U.S. Census Estimates of Whites, Blacks, Hispanics, and Asians in U.S. Info Tech in 2014</b>
```{r, echo=FALSE, cache=TRUE}
    print(dfTable1A, row.names=FALSE)   
```
 <br />   

Question 1B -- What percentage of the U.S. population was White, Black, Hispanic, Asian, and others in 2014?    
