---
title: "Best States for American Black, Hispanic, Asian, and Female Tech -- Version 0.99B"
...
* If all other things were equal, one would expect that the percentage of a state's tech sector that was Black American would be about the same as the percentage of the state's total workforce that was Black American. One would expect similar parity for the percentages of Hispanic Americans and for American females. But all things were not equal, so the percentage of the tech sector of most states that was Black, Hispanic, or female Americans was substantially smaller than the percentage of the state's total workforce that was Black, Hispanic, or female. By contrast, the percentage of state tech sectors that was Asian American was usually greater than their workforce percentage and ranged as high as `r dfTable6["Asian", "Max"]` times the Asian workforce percentage. (See Tables 4C and 6)  

* Female American tech professionals only held `r prettyNum(dfTable2B["Per","Female"])` percent of the nation's `r prettyNum(dfTable2B["Num","ALL"], big.mark=",", scientific=FALSE)` of the tech positions that were occupied by Americans. But Asian American females occupied disproportionately larger shares of the tech sectors in most states than their share of each state's workforce. Indeed, their tech shares ranged as high as `r dfTable6["FemAsian", "Max"]` times their shares of state workforce populations. (See Table 4E and Table 6.) By contrast, non-Asian American females occupied much smaller shares of the state tech sectors than their shares of the state workforce populations. (See Tables 2B, 3 and 6.) Furthermore American females held a smaller share of jobs allocated to American tech professionals in 2015 than they did in 2010, i.e., `r prettyNum(dfTable3ABC[1,"perF15"], big.mark=",", scientific=FALSE)` percent in 2015 vs. `r prettyNum(dfTable3D[1,"perF10"], big.mark=",", scientific=FALSE)` percent in 2010. (See Table 3ABC and 3D)
...
#### Question 1A -- How large were the White, Black, Asian, and Hispanic American components of the workforce of the 50 states plus the District of Columbia in 2015?    
Answer 1A ... In 2015, as shown in Table 1A (below), there were approximately `r prettyNum(dfTable1A["Num","ALL"], big.mark=",", scientific=FALSE)` citizens in the workforce, a/k/a "labor force", in the 50 states plus DC, i.e., citizens 16 and over who held a job or were temporarily unemployed. The largest of the four racial/ethnic groups discussed in this report was White American (`r prettyNum(dfTable1A["Num","White"], big.mark=",", scientific=FALSE)`); the smallest was Asian American (`r prettyNum(dfTable1A["Num","Asian"], big.mark=",", scientific=FALSE)`). Hispanic Americans, the largest minority (`r prettyNum(dfTable1A["Num","Hispanic"], big.mark=",", scientific=FALSE)`), had grown substantially larger than Black Americans (`r prettyNum(dfTable1A["Num","Black"], big.mark=",", scientific=FALSE)`).

<b>Table 1A -- Racial/Ethnic Composition of the U.S. Workforce in 2015</b>
...
#### Question 2A -- What was the ratio of American males to American females in the total U.S. workforce in 2015?

Answer 2A ... As shown in Table 2A (below), the U.S. workforce was close to an even split between males and females. But given the focus of this report, the table also breaks the female half into a small Asian  component (`r dfTable2A["Per", "FemAsian"]` percent) and a much larger non-Asian female component (`r dfTable2A["Per", "FemNonAsian"]` percent)
...
Answer 3B ... The total number of American techs in each category appear the second column of Table 3ABC (below). The top row shows that there were approximately `r prettyNum(dfTable3ABC[dfTable3ABC$Occupation=="ALL","Tech2015"], big.mark=",", scientific=FALSE)` professionals in  all tech categories. 
...
### Question 5 -- Was the size of an American group's share of a state's workforce related to its share of the tech jobs in that state? 
...
Table 1A showed that `r dfTable1A["Per","Black"]` percent of the total U.S. workforce in 2015 was Black American; and Table 1B showed that the nation's `r dfTable1B["Num","Black"]`   Black American tech professionals represented `r dfTable1B["Per","Black"]` percent of the nation's `r dfTable1B["Num","ALL"]` American tech professionals. 
