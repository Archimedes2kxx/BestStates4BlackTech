...
* Finally, in 2015 the U.S. information technology sector employed `r prettyNum(dfTable3F[1,"As2015"], big.mark=",", scientific=FALSE)` foreign tech professionals from Asia who moved here to work for their clients in this country. U.S. tech also employed `r prettyNum(dfTable3G[1,"NAs2015"], big.mark=",", scientific=FALSE)` foreign  professionals who came here from countries outside of Asia. It should be noted that the number of tech professionals from Asia in 2015 was `r prettyNum(dfTable3F[1,"Ch_%"], big.mark=",", scientific=FALSE)` percent larger than it was in 2010, i.e., `r prettyNum(dfTable3F[1,"As2010"], big.mark=",", scientific=FALSE)`. The 2015 figure was also substantially larger than the `r prettyNum(dfTable1B["Num","Black"], big.mark=",", scientific=FALSE)` Black American or the  `r prettyNum(dfTable1B["Num","Hispanic"], big.mark=",", scientific=FALSE)` Hispanic American professionals employed by U.S. tech in 2015.  (See Tables 3D, 3E, and 3F.)
...
#### Question 1A -- How many White, Black, Asian, and Hispanic residents lived in the U.S. in 2015?    
...
#### Question 2A -- What was the American male/female composition of the U.S. population in 2015?
...
#### Question 2B -- What was the American male/female composition of the tech sector in 2015? 

Answer 2B ... As shown in Table 2B (below), the ratio of male to female techs was about  `r round(as.numeric(dfTable2B["Per", "Male"])/as.numeric(dfTable2B["Per", "Female"]), digits=0)` to 1, more specifically `r dfTable2B["Per", "Male"]` percent to `r dfTable2B["Per", "Female"]` percent. The ratio of Non-Asian American females to Asian American females was about `r round(as.numeric(dfTable2B["Per", "FemNonAsian"])/as.numeric(dfTable2B["Per", "FemAsian"]), digits=0)` to 1, i.e., `r dfTable2B["Per", "FemNonAsian"]` percent to `r dfTable2B["Per", "FemAsian"]` percent.

<b>Table 2B -- American Male/Female Composition of the U.S. Tech Sector in 2015</b>   
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
Answer 3A ... For the purposes of this report, "information technology" was defined as the thirteen standard occupation categories (SOC) that appear in the first column of Table 3ABC (below). Twelve of these categories related to software, e.g., Software Developers, Computer Programmers, and Database Administrtors; only one relates to hardware, i.e., Computer Hardware Engineers.  The thirteen categories in the tables in this section provide profiles of the American professionals in U.S. tech in 2015, of the foreign professionals in U.S. tech in 2015, and of the changes in these profiles between 2010 and 2015.
...
#### Question 3C -- What was the American male/female breakdown of employment within these categories?         
...
Answer 3D ... As per Table 3E (below), there were blah, blah, blah   ...
...
Answer 4 ... The following sections provide an extensive response to a more specific formulation of this question ==> In which states did American White, Black, Asian, Hispanic, and female  tech professionals work in 2015?  
...
<b> Asian Americans vs. Black Americans</b>   
