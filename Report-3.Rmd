...
Answer 4 ... To be more specific, in which states did White, Black, Asian, and Hispanic techs reside in 2014? The underlying assumption that most people work in the same state in which they live. (<i>Readers should be aware of two notable exceptions: New York and Washington, DC wherein substantial numbers of out-of-state workers commute from nearby New Jersey and Connecticut, and from Maryand and Viginia respectively.</i>) 

I've presented the U.S. Census data that answers this question in two formats: as a set of choropleth maps and as a corresponding set of tables. I show the maps first because it's easier to see the similarities and differences between the residential patterns of the racial/ethnic groups by looking at multicolored maps than by scanning the columns of data in the tables. Indeed, a quick scan of the maps makes it easier to see the same patterns in the data tables.
...
<b> Maps 4A (Whites), 4B (Blacks), 4C (Asians) and 4D (Hispanics), --  -- Lower 48 and DC</b>
...
* Map 4B shows that Black techs are concentrated in the Eastern and Southern states, with the most living in Texas, second in Georgia, and third in Virginia

* Map 4C shows that Hispanics are concentrated in California, Texas, and Florida  

* Map 4D shows that the Asian concentrqtion in California is much higher than the concentration of any other group in any state. Otherwise Asians are spread out over states with much smaller Asian populations.
