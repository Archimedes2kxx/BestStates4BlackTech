...
* For the final 1.0 version of this report I will download another PUMS data sample, this  time with variables that indicate whether each member of the sample was a U.S. citizen and whether each member was born in Asia. Version 1.0 -- titled "Best States for Black, Hispanic, Female, and Asian Tech" -- will examine parity data for Asian Americans. I will then post a companion op-ed -- titled "Why Are There So Many Asian Asians in U.S. Tech?" -- that will offer a plausible answer to its title's question.
