...
This note provides a convenient reference for answers to some basic questions about diversity in the U.S. information technology sector, i.e., "diversity in tech". To be specific, it presents the results of my examination of U.S. Census data about the employment of Blacks and Hispanics in the information technology sectors of all 50 states plus the District of Columbia in 2014. My principal findings are straight-forward:   
...
### A. Demographics of Race, Sex, and Location   
...
```{r, echo=FALSE, cache=FALSE}
    colnames(dfTable1A) <- c("ALL", "White", "Black", "Hispanic", "Asian", "Others")
...
```{r, echo=FALSE, cache=FALSE}
    colnames(dfTable1B) <- c("ALL", "White", "Black", "Hispanic", "Asian", "Others")
...
```{r, echo=FALSE, cache=FALSE}
    colnames(dfTable2A) <- c("ALL", "White", "Black", "Hispanic", "Asian", "Others")
...
```{r, echo=FALSE, cache=FALSE}
    colnames(dfTable2B) <- c("ALL", "White", "Black", "Hispanic", "Asian", "Others")
...
```{r, echo=FALSE, cache=FALSE}
    colnames(dfTable3) <- c("Occupation", "AllTech", "Male", "%_Male")
    print(dfTable3[,c(1,2,4)], row.names=FALSE)  
```
...
<br />... Comments    <br/><br />
<b>Map 4 -- Whites, Blacks, Hispanics, and Asians -- U.S. Information Technology -- Lower 48 and DC</b>
```{r, echo=FALSE, cache=FALSE}
...
```{r, echo=FALSE, cache=FALSE}
    colnames(dfTable4A) <- c("State", "AllTech", "State_%", "WhiTech", "%_WhiTech", "WhiPop", "%_WhiPop", "Parity")
    print(dfTable4A[1:11,], row.names=FALSE)  
```
<br />

<br />... Comments and reformatting of table </br>
<b>Table 4B -- Blacks in U.S. Information Technology -- Top 10 states</b>... Comments and reformatting of table
```{r, echo=FALSE, cache=FALSE}
    colnames(dfTable4B) <- c("State", "AllTech", "State_%", "BlkTech", "%_BlkTech", "BlkPop", "%_BlkPop", "Parity")
    print(dfTable4B[1:11,], row.names=FALSE)  
```

<br />... Comments and reformatting of table </br>
<b>Table 4C -- Hispanics in U.S. Information Technology -- Top 10 states</b>
```{r, echo=FALSE, cache=FALSE}
    colnames(dfTable4C) <- c("State", "AllTech", "State_%",  "HspTech", "%_HspTech", "HspPop", "%_HspPop", "Parity")
    print(dfTable4C[1:11,], row.names=FALSE)  
```
<br />
<br />... Comments and reformatting of table </br>
<b>Table 4D -- Asians in U.S. Information Technology -- Top 10 states</b>
```{r, echo=FALSE, cache=FALSE}
    colnames(dfTable4D) <- c("State", "AllTech", "State_%", "AsnTech", "%_AsnTech", "AsnPop", "%_AsnPop", "Parity")
    print(dfTable4D[1:11,], row.names=FALSE)  
```
<br /><br />
