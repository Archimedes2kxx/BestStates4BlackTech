---
title: "Best States for Black, Hispanic, Asian, and Female Tech -- Version 0.94"
...
Answer 3B ... The total number of techs in each category appear the second column of Table 3 (below). The top row shows that there were approximately `r prettyNum(dfTable3[dfTable3$Occupation=="ALL","TechStaff"], big.mark=",", scientific=FALSE)` professionals in  all tech categories. 

#### Question 3C -- What was the male/female breakdown of employment within these categories?         
Answer 3C ... The fourth column of Table 3 (below) shows the percentage of techs in the second column who were female. Females were an overall minority of `r dfTable3[dfTable3$Occupation=="ALL","F_%"] `% of all professionals in tech, and were a minority in every tech category, ranging from a low value of `r prettyNum(min(dfTable3[, "F_%"]), scientific=FALSE)`% for to a high value of `r prettyNum(max(dfTable3[, "F_%"]), scientific=FALSE)`%.

<b>Table 3 -- Employment in U.S. Information Technology in 2015 with Female Percentages</b>   
```{r, echo=FALSE, cache=FALSE,  comment=NA}
   print(format(dfTable3[,c(1:3, 7)], big.mark=","),row.names=FALSE) 
```
