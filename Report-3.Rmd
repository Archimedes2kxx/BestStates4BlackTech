---
title: "Best States for Black, Hispanic, Asian, and Female Tech -- Version 0.93"
...
* If all other things were equal, one would expect that the percentage of a state's tech sector that was Black would be about the same as the percentage of the state's total population that was Black. One would expect similar parity for the percentages of Hispanics and for females. But all things were not equal, so I found that the percentage of the tech sector of most states that was Black, Hispanic, or female was substantially smaller than the percentage of the state's total population that was Black, Hispanic, or female. By contrast, I found that the percentage of state tech sectors that was Asian was usually greater than their population percentage and ranged as high as `r dfTable6["Asian", "Max"]` times their population percentage. (See Tables 4C and 6)  

* Female American tech professionals only held `r prettyNum(dfTable2B["Percent","Female"])` percent of the nation's `r prettyNum(dfTable2B["Number","ALL"], big.mark=",", scientific=FALSE)` of the tech positions occupied by Americans. After considering the disproportionate number of tech positions allocated to Asian American techs, I split the American female tech category into Asian American females and non-Asian American females. I then found that Asian American females also occupied disproportionately larger shares of the tech sectors in most states than their share of each state's population. Indeed, their tech shares ranged as high as XXXXX times their shares of state populations. (See Table 4E and Table 6.) By contrast, non-Asian American females occupied much smaller shares of the state tech sectors than their shares of the state populations. (See Tables 2B, 3 and 6.)   

* Finally, in 2015 the U.S. information technology sector employed XXXX foreign tech professionals, most of whom came from Asia. It should be noted that this figure is almost as large as the combined total number of Black Americans (`r prettyNum(dfTable1B["Number","Black"], big.mark=",", scientific=FALSE)`) and Hispanic Americans ( `r prettyNum(dfTable1B["Number","Hispanic"], big.mark=",", scientific=FALSE)`) employed by the U.S. tech sector. 
...
My brief answers to the first three questions provide a broad statistical framwork for my extended responses to the fourth and fifth questions that form the core of this report. <b>Note: all the tables in this version of the report refer to techs who are U.S. citizens. </b>
...
#### Question 4 -- Where did the nation's Black, Hispanic, and female Anerican tech professionals work in 2015?      
...
* The final 1.0 version of this report will use additional Census data to determine the number and geographical distribution of foreign Asian professionals in U.S. tech, i.e., how many are employed in each state. I will then post a companion op-ed -- "Why Are There So Many Foreign Asians in U.S. Tech?" -- that will offer a plausible answer to the question in its title. <b>Reminder: all the tables in this version of the report refer to tech professionals who are U.S. citizens.</b>

<b>Table 9. Foreign Workers in the Biggest Tech States</b>
```{r, echo=FALSE, cache=FALSE, comment=NA}
