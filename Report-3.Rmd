...
#### Question 1A -- How large were the White, Black, Asian, and Hispanic American components of the nation's total workforce in 2015?    
Answer 1A ... In 2015, as shown in Table 1A (below), the largest of the four racial/ethnic groups discussed in this report was White American (`r prettyNum(dfTable1A["Num","White"], big.mark=",", scientific=FALSE)`); the smallest was Asian American (`r prettyNum(dfTable1A["Num","Asian"], big.mark=",", scientific=FALSE)`). Hispanic Americans, the largest minority (`r prettyNum(dfTable1A["Num","Hispanic"], big.mark=",", scientific=FALSE)`), had grown substantially larger than Black Americans (`r prettyNum(dfTable1A["Num","Black"], big.mark=",", scientific=FALSE)`).
