---
title: "Best States for American Black, Hispanic, Asian, and Female Tech -- Version 0.99J"
...
perFemIncrease <- round(100 * (dfTable3Z[1,"Fem"] - dfProfileZ.2010[1,"Female"])/dfProfileZ.2010[1,"Female"], digits=1)
...
<i>Question 2B</i> -- What was the foreign (non-American) male/female composition of the tech sector in the 50 states plus the District of Columbia in 2015?
...
<i>Question 3.0</i> -- How many American male vs. female techs were in each category in 2010 and 2015 in the 50 states and the District of Columbia?
 ...
 <i>Answer 3.0</i> ... As per its title, Tables 3Z and 3ZZ (below) only contains data about tech workers who were American citizens; data about foreign workers will appear in Table 3E and 3F (subsequent.)
...
*  California accounted for `r caPerForeignIncrease` percent of the  `r prettyNum(dfTable3EE[1,"Change"], big.mark=",", scientific=FALSE)` increase in the number of foreign professionals working in U.S. tech during that time frame. The remaining `r otherPerForeignIncrease` percent was spread across the other 49 states and the District of Columbia.
...
<b> Asian American  Black American</b>   
...
* The DLL will soon post a companion op-ed -- <i>"Why Are There So Many Foreign Asian Professionals in U.S. Tech?</i>" -- that will offer a plausible answer to the question in its title based on the data compiled for this report.
...
## Appendix -- Profiles of Racial/Ethnic Group, Sex, and Foreign Composition of Six Biggest Tech States in 2015

### California    

 <b>Table 3CAfor -- California Foreign Male/Female Composition of U.S. Tech in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3CAfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3CACAfor -- Changes in the California Foreign Male/Female Composition of U.S. Tech between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<b>Table 3TXfor -- Texas Foreign Male/Female Composition of U.S. Tech in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3TXfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3TXTXfor -- Changes in the Texas Foreign Male/Female Composition of U.S. Tech between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
### New York   
 ...
 <b>Table 3NYfor -- New York Foreign Male/Female Composition of U.S. Tech in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3NYfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3NYNYfor -- Changes in the New York Foreign Male/Female Composition of U.S. Tech between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<b>Table 3FLfor -- Florida Foreign Male/Female Composition of U.S. Tech in 2015</b>
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3FLfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3FLFLfor -- Changes in the Florida Foreign Male/Female Composition of U.S. Tech between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<b>Table 3VAfor -- Virginia Foreign Male/Female Composition of U.S. Tech in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3VAfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3VAVAfor -- Changes in the Virginia Foreign Male/Female Composition of U.S. Tech between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
...
<b>Table 3ILfor -- Illinois Foreign Male/Female Composition of U.S. Tech in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3ILfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3ILILfor -- Changes in the Illinois Foreign Male/Female Composition of U.S. Tech between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
