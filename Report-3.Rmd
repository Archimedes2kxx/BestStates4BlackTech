...
* As can be seen from the tables in the <B>[APPENDIX](https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html#appendix-profiles-of-racialethnic-groups-sex-and-foreign-composition-of-six-biggest-tech-states-in-2015)</b> section of this report, California's increased use of foreign tech professionals in the last few years was orders of magnitude larger than other states. California's foreign tech tables display four digit percentage increases in the importation of foreign techs. Whereas the increased use of foreign techs by the other five big tech states and the District of Columbia might have been tactical respononses to local shortfalls in the availability of American techs, California's substantially larger use of foreign professionals seemed more like a long-term strategy that was widely shared by upper level tech managers in that state, especially in Silicon Valley.
...
* The fourth pair of tables show changes in employment of foreign professionas between 2010 and 2015 in the state's tech sector.   
...
<P style="page-break-before: always">    
<b>Table 3.CAfor -- Foreign Male/Female Tech in California in 2015</b>  
```{r, echo=FALSE, cache=TRUE, comment=NA}
   print(format(dfTable3CAfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3.CACAfor -- Changes in Foreign Male/Female Tech in California 2010 to 2015</b> 
```{r, echo=FALSE, cache=TRUE, comment=NA}
...
<P style="page-break-before: always">    
<b>Table 3.TXfor -- Foreign Male/Female Tech in Texas in 2015</b>  
```{r, echo=FALSE, cache=TRUE, comment=NA}
   print(format(dfTable3TXfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3.TXTXfor -- Changes in Foreign Male/Female Tech in Texas 2010 to 2015</b> 
```{r, echo=FALSE, cache=TRUE, comment=NA}
...
<P style="page-break-before: always">    
<b>Table 3.NYfor -- Foreign Male/Female Tech in New York 2015</b>  
```{r, echo=FALSE, cache=TRUE, comment=NA}  
   print(format(dfTable3NYfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3.NYNYfor -- Changes in Male/Female Tech in New York 2010 to 2015</b> 
```{r, echo=FALSE, cache=TRUE, comment=NA}
...
<P style="page-break-before: always">    
<b>Table 3.FLfor -- Foreign Male/Female Tech in Florida in 2015</b>
```{r, echo=FALSE, cache=TRUE, comment=NA}
   print(format(dfTable3FLfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3.FLFLfor -- Changes in Foreign Male/Female Tech in Florida 2010 to 2015</b> 
```{r, echo=FALSE, cache=TRUE, comment=NA}
...
<P style="page-break-before: always">    
<b>Table 3.VAfor -- Foreign Male/Female Tech in Virginia in 2015</b>  
```{r, echo=FALSE, cache=TRUE, comment=NA}
   print(format(dfTable3VAfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3.VAVAfor -- Changes in Foreign Male/Female Tech in Virginia 2010 to 2015</b> 
```{r, echo=FALSE, cache=TRUE, comment=NA}
...
<P style="page-break-before: always">       
<b>Table 3.ILfor -- Foreign Male/Female Tech in Illinois in 2015</b>  
```{r, echo=FALSE, cache=TRUE, comment=NA}
   print(format(dfTable3ILfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3.ILILfor -- Changes in Foreign Male/Female Tech in Illinois</b> 
```{r, echo=FALSE, cache=TRUE, comment=NA}
...
<P style="page-break-before: always">       
<b>Table 3.DCfor -- Foreign Male/Female Tech in DC in 2015</b>  
```{r, echo=FALSE, cache=TRUE, comment=NA}
   print(format(dfTable3DCfor, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3.DCDCfor -- Changes in Foreign Male/Female Tech in DC</b> 
```{r, echo=FALSE, cache=TRUE, comment=NA}
   print(format(dfTable3DCDCfor, big.mark=","), row.names=FALSE, quote=FALSE)
```
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>    
