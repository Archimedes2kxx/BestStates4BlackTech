---
title: "Best States for Black, Hispanic, Asian, and Female Tech -- Version 0.92"
...
#### Question 1A -- How many White, Black, Asian, and Hispanic tech professionals worked in the U.S. in 2015?    
...
#### Question 1B -- How many White, Black, Asian, and Hispanic professionals worked in tech in 2015? 
...
Answer 3B ... The total number of techs in each category appear the second column of Table 3 (below). The top row shows that there were approximately `r prettyNum(dfTable3[dfTable3$Occupation=="ALL","AllTech"], big.mark=",", scientific=FALSE)` professionals in  all tech categories. <b>Note that this total includes  all techs in the U.S., citizens and foreign. All subsequent tables in this version of the report will only refer to techs who are U.S. citizens. A later version of this report will modify the subsequent tables so that they also refer to all techs, citizens and foreign. </b>
...
<b>Table 3 -- Employment in U.S. Information Technology in 2015 with Female Percentages</b>   
```{r, echo=FALSE, cache=FALSE,  comment=NA}
   print(format(dfTable3[,c(1:2,6)], big.mark=","),row.names=FALSE) 
```
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>    

#### Question 4 -- Where did the nation's Black, Hispanic, and female tech professionals work in 2015?      
Answer 4 ... The following sections provide an extensive response to a more specific formulation of this question ==> In which states did White, Black, Asian, Hispanic, and female tech professionals work in 2015?  
...
<b> Black vs. Black</b>   
First, let me remind the reader that Table 1A showed that `r dfTable1A["Percent","Black"]` percent of the U.S. population in 2015 was Black; and Table 1B showed that the nation's `r dfTable1B["Number","Black"]`   Black tech professionals represented `r dfTable1B["Percent","Black"]` percent of the nation's `r dfTable1B["Number","ALL"]` tech professionals. 
...
* For the final 1.0 version of this report I will download another PUMS data sample, this  time with variables that indicate whether each member of the sample was a U.S. citizen and whether each member was born in Asia. "Best States for Black, Hispanic, Female, and Asian Tech, Version 1.0" will examine parity data for Asian Americans. I will then post a companion op-ed -- "Why Are There So Many Asian Asians in U.S. Tech?" -- that will offer a plausible answer to the question in its title. <b>Note: Tables 4 through 9 in the current version of this report only refer to techs who are U.S. citizens. In a later version, the "tech" columns in these tables will refer to the total number of all techs in each state, i.e., the combined totals of citizens and foreign techs.</b>
