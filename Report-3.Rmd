...
4. <b>Best States</b>    
I chose the "Best States" by sorting the lists of finalists in decreasing order of each group's percentage share (T_%) of the tech sector. My original intention was to select the top three finalists according to this ranking. But no list had more than three finalists; so all finalists were selected for each group. The state at the top of each list was the best of the best for its group, the state in the second row was the second best, and so on. <b>It should be noted that California was only "Best States" for White professionals.</b> 
