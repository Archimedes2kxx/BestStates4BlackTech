...
```{r, echo=FALSE, cache=FALSE}
    colnames(dfTable3) <- c("Occupation", "AllTech", "Male", "%_M")
...
```{r, echo=FALSE, cache=TRUE}
    grid.arrange(dfMap4A, dfMap4B, dfMap4C, dfMap4D, ncol=2) ###, ggPlot_white, ncol=2) ###, ggPlot_black, ggPlot_hispanic, ncol=2)
    ###print(dfMap4A)  
...
<i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i>
<br />... Comments and reformatting of table </br>
#### Table 4B -- Blacks in U.S. Information Technology -- Top 10 states <br />
... Comments and reformatting of table
```{r, echo=FALSE, cache=FALSE}
...
```{r, echo=FALSE, cache=FALSE}
    colnames(dfTable5) <- c("Min", "Q1", "Median", "Mean", "Q3", "Max", "Beta1000")
    print(dfTable5)  
```
<br />
<i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i>
...
#### Question 7 -- How did the size of a racial/ethnic group's population in a state relate to the group's share of the  state's tech jobs?<br />
