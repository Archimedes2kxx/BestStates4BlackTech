...
```{r, echo=FALSE, cache=TRUE}
    colnames(dfTable4A) <- c("State", "AllTech", "WhiTech", "%_WhiTech", "WhiPop", "%_WhiPop", "Parity")
...
```{r, echo=FALSE, cache=TRUE}
    colnames(dfTable4B) <- c("State", "AllTech", "BlkTech", "%_BlkTech", "BlkPop", "%_BlkPop", "Parity")
...
```{r, echo=FALSE, cache=TRUE}
    colnames(dfTable4C) <- c("State", "AllTech", "HspTech", "%_HspTech", "HspPop", "%_HspPop", "Parity")
...
```{r, echo=FALSE, cache=TRUE}
    colnames(dfTable4D) <- c("State", "AllTech", "AsnTech", "%_AsnTech", "AsnPop", "%_AsnPop", "Parity")
