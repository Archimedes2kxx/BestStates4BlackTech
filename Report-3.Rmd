...
* The number of tech jobs held by Americana grew by `r prettyNum(dfTable3ZZ[1,"perCh"], big.mark=",", scientific=FALSE)` xxx percent between 2010 and 2015, i.e., from  `r prettyNum(dfTable3ZZ[1,"Tech10"], big.mark=",", scientific=FALSE)` xxx to  `r prettyNum(dfTable3ZZ[1,"Tech15"], big.mark=",", scientific=FALSE)` xxx; the number tech jobs held by White Americans grew by `r prettyNum(dfTable3AA[1,"perCh"], big.mark=",", scientific=FALSE)` xxx percent, i.e., from `r prettyNum(dfTable3AA[1,"Tech10"], big.mark=",", scientific=FALSE)` xxx to `r prettyNum(dfTable3AA[1,"Tech15"], big.mark=",", scientific=FALSE)` xxx; tech jobs held by Black Americans grew by xxx percent, i.e., from xxx to xxx; tech jobs held by Asian Americans grew by xxx percent, i.e., from xxx to xxx; and  tech jobs held by Hispanic Americans grew by xxx percent, i.e., from xxx to xxx. (See tables 3, 3AA, 3BB, 3CC, and 3DD)  
...
<i>Question 3</i> -- How many American male vs. female techs were in each category in 2010 and 2015 in the 50 states and the District of Columbia?

 <i>Answer 3</i> ... blah, blah, blah
