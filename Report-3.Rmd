...
* The final 1.0 version of this report will use additional Census data to determine the number and geographical distribution of foreign professionals in U.S. tech, i.e., how many were employed in each state. I will then post a companion op-ed -- "Why Are There So Many Foreign Asian Professionals in U.S. Tech?" -- that will offer a plausible answer to the question in its title. <b>Reminder: all the tables in this version of the report refer to tech professionals who are U.S. citizens.</b>
