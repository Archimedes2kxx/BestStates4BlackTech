...
7. <b>P_%</b> -- Percent of the state's total population that belonged to the table's racial/ethnic group. For example, Table 4A shows that in 2014,  `r dfTable4A[dfTable4A=="California", 7]` percent of the total population of California was White; `r dfTable4A[dfTable4A=="Texas", 7]` percent of the total population of Texas was white<br /><br />
...
* This story is told more succinctly by the parity values in the last column of the Table 4A (and in its full version). White parity values are all close to 1.0, which means that the percentage of techs who were White in each state was more or less the same as the percentage of Whites in the state's total population. So California being the most populous state had the most White techs. In other words, if you walked into a tech office in any state in they USA, you would probably encounter the same percentage White techs as the percentage of White people you would encounter walking down the street -- with an important caveat. As per table 3 (above), if you randomly encountered 10 White people on a street, only five of them would be males; but random encounters with 10 White techs in an office would probably involve seven or eight males.
...
* As per column 2 of Table 4B, in 2014 the largest number of Black techs lived in Texas, second largest in Georgia, third in Virginia, fourth in New York, fifth in Maryland, sixth in Florida, and finally, in seventh place came the Great State of California. Why? Because in 2014 the vast majority Black Americans still lived in Eastern and Southern states; so that's where most of the Black techs were found. This placed Black techs at a considerable disadvantage with regards to learning about/being recruited for tech jobs in Silicon Valley.

* As I noted earlier, Washington, DC had a large commuter population. More specifically, substantial numbers of Black professionals lived in its southern Maryland and Northern Virginia suburbs. Therefore the number of Black techs who worked in DC in 2014 may have been substantially larger than the number who lived there.   

* I must also note my personal surprise that the largest number of Black techs lived in Texas. Indeed, I am embarrassed by my prior ignorance. Texas was not only home to the largest number of Black techs (`r prettyNum(dfParity_black["Texas", "blackTech"], big.mark=",", scientific=FALSE)`) in 2014, it was also distinguished by the highest parity rating (`r dfParity_black["Texas", "parity"]`) of the top ten states in Table 4B.
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small> 

<b>Table 4C -- Asians in U.S. Information Technology -- Top 10 states</b>    
[Click here for full version](Table4C-Full-Asian-Employment.html)
...
<b>Table 4D -- Hispanics in U.S. Information Technology -- Top 10 states</b>      
 [Click here for full version](Table4D-Full-Hispanic-Employment.html) 
...
#### Question 5 -- Did the Black/Hispanic shares of tech employment equal their shares of a state's population?     
