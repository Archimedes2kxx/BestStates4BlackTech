...
Answer 4 ... The following extensive answer responds to a more specific formulation of this question ==> In which states did White, Black, Asian, and Hispanic techs reside in 2014? My underlying assumption was that most people worked in the same state in which they lived. (<i>Readers are reminded of two notable exceptions: New York City and Washington, DC wherein substantial numbers of out-of-state workers commute from nearby New Jersey and Connecticut, and from Maryand and Viginia respectively.</i>) 
...
Four corresponding data tables impose numeric precision on the qualitative insights provided by the maps. The short versions of each table only contain the top ten rows are displayed below. To view the full tables that contain data for all 50 states plus the District of Columbia, please click the link below the table name. Each table (full table and short version) has the following eight columns<br /><br />
