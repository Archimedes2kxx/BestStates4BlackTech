...
* Approximately `r prettyNum(dfTable1E["Num","Asian"], big.mark=",", scientific=FALSE)` foreign employees in the U.S. tech sector were from Asia; and `r prettyNum(dfTable1E["Num","Non-Asian"], big.mark=",", scientific=FALSE)` were from non-Asian countries. (See Table 1E)
...
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable1A, big.mark=","), quote=FALSE, row.names=TRUE)
```
...
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable1C, big.mark=","), row.names=TRUE, quote=FALSE)
```
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>      
...
```{r, echo=FALSE, cache=FALSE, comment=NA}
    print(format(dfTable1D, big.mark=","), row.names=TRUE)
```
...
<b>Table 1E -- Asian and Non-Asian Components of the U.S. Tech Sector in 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable1E, big.mark=","), row.names=TRUE, quote = FALSE)
```
<small><i><center><a href="https://archimedes2kxx.github.io/BestStatesForBlackTech/Report-3.html" target="_self">back-to-top</a></center></i></small>   
...
<i>Question 3C</i> -- How many Asian American male vs. female techs were in each category in 2010 and 2015 in the 50 states and the District of Columbia?

 <i>Answer 3C</i> ... Data for Asian American techs in 2015 is in Table 3C; data that compares 2010 to 2015 is in Table 3CC.
...
<i>Question 3F</i> -- How many foreign male vs. female tech were in each category in 2010 and 2015 in California? 
  ...
  <i>Answer 3F</i> ... Data for foreign techs working in California in 2015 is in Table 3F; data that compares 2010 employment to 2015 is in Table 3FF. Note that the huge increases in the estimated number of foreign techs in all job categories were reflected in the four digit percentage increases shown in the "perCh" column. The "Inf" entries (abbreviations for "Infinite") merely indicates that there were zero foreign techs in those categories in 2010.   
...
### Florida   
 ...
 <b>Table 3FL -- Florida Foreign Male/Female Composition of U.S. Tech in 2015</b>  
```{r, echo=FALSE, cache=FALSE, comment=NA}
   print(format(dfTable3FL, big.mark=","), row.names=FALSE, quote=FALSE)
```

<b>Table 3FLFL -- Changes in the Florida Foreign Male/Female Composition of U.S. Tech between 2010 and 2015</b> 
```{r, echo=FALSE, cache=FALSE, comment=NA}
