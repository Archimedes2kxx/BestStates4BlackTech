...
4. <b>Best States</b>    
I chose the "Best States" by sorting the lists of finalists in decreasing order of each group's percentage share (T_%) of the tech sector. The state at the top of each list was the best of the best for its group, the state in the second row was the second best, and so on. 
...
* My recent telephone conversation with a member of the U.S. Census Bureau's ACS user support team confirmed my understanding that the extensive PUMS sample data that I originally downloaded did not distinguish between Americans and foreign residents. So the Asian data in Map 4C and Tables 4C, 6, and 8C combined two distinct subgroups -- Asian Americans and foreign Asians who were probably in this country on H-1B work visas. These foreign tech professionals had the strongest possible "weak ties" to their future employers because they had been proactively recruited by agents of U.S. companies who persuded them to work for their U.S. clients in the U.S.
