...
Kurosawa's [<b>Rashomon</b>](http://www.imdb.com/title/tt0042876/) is one of those great films that challenge its viewers to really think about what they have seen. As in real life, each version has omissions and inconsistencies that alert the viewer that each version is not the truth, the whole truth, and nothing but the truth. Even the supposedly neutral observer's version seemed to be shaped in a way to cast the observer in a favorable light. Some viewers conclude that the point of the film is that truth is unknowable. I'm not so pessimistic. To me the film is a reminder that truth is attainable but is rarely as simple as it first appears to be, that multiple perspectives provide useful insights, even when they seem to be in conflict with each other.   
...
Each view of the issue leads to solution strategies, but different views lead to different strategies. 
